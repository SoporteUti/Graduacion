...
Vue.component('notification', __webpack_require__(37));
...
var update = __webpack_require__(41)("2cc8c3b5", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        loadData: function loadData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/users/notifications').then(function (_ref) {
                var data = _ref.data;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    typeNotification: function typeNotification(notificationType) {
      if (notificationType == "sispg\\Notifications\\SolicitudAprobacionTema") {
        this.threadUrl = 'Aprobacion de tema';
        return 0;
      } else if (notificationType == "sispg\\Notifications\\SolicitudIrorrogaInterna") {
        this.threadUrl = 'Prorroga Interna';
        return 1;
      } else if (notificationType == "sispg\\Notifications\\SolicitudRatificacionResultados") {
        this.threadUrl = 'Ratificacion de Resultados';
        return 2;
      } else if (notificationType == "sispg\\Notifications\\SolicitudRatificacionTribunal") {
        this.threadUrl = 'Ratificacion de Tribunal';
        return 3;
      } else if (notificationType == "sispg\\Notifications\\SolicitudReprobacionAbandono") {
        this.threadUrl = 'Reprobacion por Abandono';
        return 4;
      } else if (notificationType == "sispg\\Notifications\\NotificacionInasistencia") {
        this.threadUrl = 'Reprobacion por Inasistencia';
        return 5;
      } else if (notificationType == "sispg\\Notifications\\NotificacionCalidadEgresadoPorCaducar") {
    ...
    readNotification: function readNotification(notification_id) {
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/users/notifications/read/' + notification_id).then(function (_ref) {
        var data = _ref.data;
      ...
      "a",
      {
        ...
        on: {
          click: function($event) {
            _vm.readNotification(_vm.unread.id)
          }
        }
      },
      [
        _c("div", { staticClass: "col-lg-8 col-sm-8 col-8" }, [
          _c("strong", [_vm._v(_vm._s(_vm.threadUrl))]),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 0
            ? _c("div", [
                _c("p", [
                  _vm._v(
                    "Hay una solicitud de aprobación de tema para el grupo: "
                  ),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))])
                ])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 1
            ? _c("div", [
                _c("p", [
                  _vm._v("El grupo: "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                  _vm._v(" ha solicitado prorroga ")
                ])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 2
            ? _c("div", [
                _c("p", [
                  _vm._v("El grupo: "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                  _vm._v(" ha solicitado una ratificacion de resultados ")
                ])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 3
            ? _c("div", [
                _c("p", [
                  _vm._v("El grupo: "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                  _vm._v(" ha solicitado una ratificacion de tribunal ")
                ])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 4
            ? _c("div", [
                _c("p", [
                  _vm._v(
                    "Se ha solicitado una reprobacion por abandono en el grupo: "
                  ),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))])
                ])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 5
            ? _c("div", [
                _c("p", [
                  _vm._v("El estudiante "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.alumno_nombre))]),
                  _vm._v(" integrante del grupo: "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                  _vm._v(" ha acumulado un total de "),
                  _c("strong", [
                    _vm._v(_vm._s(_vm.unread.data.num_inasistencias))
                  ]),
                  _vm._v(" inasistencias")
                ])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 6
            ? _c("div", [
                _c("p"),
                _vm.unread.data.type == 3
                  ? _c("div", [_vm._v("Estimado estudiante ")])
                  : _c("div", [_vm._v("El estudiante ")]),
                _c("strong", [_vm._v(_vm._s(_vm.unread.data.alumno_nombre))]),
                _vm._v(" integrante del grupo: "),
                _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                _vm._v(" su calidad de egresado esta proxima a finalizar"),
                _c("p")
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 7
            ? _c("div", [
                _c("p", [
                  _vm._v("La defensa de la etapa "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.etapa))]),
                  _vm._v(" del grupo: "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                  _vm._v(" se realizara la fecha"),
                  _c("strong", [
                    _vm._v(" " + _vm._s(_vm.unread.data.fecha) + " ")
                  ])
                ])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 8
            ? _c("div", [
                _c("p"),
                _vm.unread.data.type == 3
                  ? _c("div", [_vm._v("Estimado estudiante ")])
            ...
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 9
            ? _c("div", [
                _c("p"),
                _vm.unread.data.type == 3
                  ? _c("div", [_vm._v("Estimado estudiante integrante del")])
                  : _c("div", [_vm._v("El")]),
                _vm._v("  grupo: "),
                _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                _vm._v(" el periodo "),
                _c("strong", [_vm._v(_vm._s(_vm.unread.data.periodo))]),
                _vm._v(" para realizar la tesis: "),
                _c("strong", [_vm._v(_vm._s(_vm.unread.data.tema))]),
                _vm._v(" culminara dentro de un mes"),
                _c("p")
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 10
            ? _c("div", [
                _c("p", [
                  _vm._v(" El grupo: "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                  _vm._v(
                    " ha solicitado cambio de tema de trabajo de graduacion"
                  )
                ])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.typeNotification(_vm.unread.type) == 11
            ? _c("div", [
                _c("p", [
                  _vm._v(" El grupo: "),
                  _c("strong", [_vm._v(_vm._s(_vm.unread.data.grupo_codigo))]),
                  _vm._v(" ha solicitado prorroga a Junta Directiva")
                ])
              ])
            : _vm._e()
        ])
    ...
    [
      _c(
        "a",
        {
          ...
          staticStyle: { "padding-top": "7px", color: "white" },
            ...
            _c(
              ...
              [
                ...
                _vm.unreadNotifications.length == 0
                  ? _c("div", [_c("p", [_vm._v("No hay Notificaciones")])])
                  : _vm._e()
              ],
              2
            )
