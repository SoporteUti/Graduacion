...
class EstudianteController extends Controller
{
  public function __construct()
  {
    ...
    UtilFunctions::authorizeRoles([
      'ADMINISTRADOR', 'JEFE DE DEPARTAMENTO',
  ...
  public function store(EstudianteFormRequest $request)
  {
    ...
    try {
      ...
      Mail::send('ues.emails.confirmation_code', ['user' => $user, 'temp' => $temp, 'persona' => $persona], function ($m) use ($user) {
        $m->from('mensajerotg.fmp@ues.edu.sv', 'Control y Seguimiento de trabajo de graduación');
        $m->to($user->email, $user->name)->subject('Usuario Registrado!!');
      });
