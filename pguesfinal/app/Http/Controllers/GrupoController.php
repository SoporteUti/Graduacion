...
$departamento=Departamento::all();
  ...
  $fechas = array();
  $gantt = '';
  if ($grupos->periodo) { $grupos->periodo->fFin;
...
->with('departamento',$departamento);
 ...
 //dd($grupos, $request->input('estado'));
   ...
   $pdf=\PDF::loadview('ues.grupos.pdfestadistico',  array('anioseleccionado'=>$anioseleccionado,'estado'=>$estado,'carrera'=>$carrera,'grupos' =>$grupos, 'departamento'=>$departamento
