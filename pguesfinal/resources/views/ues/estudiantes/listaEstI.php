...
<body>
 ...
 <table width="100%" align="center" border="0" >
  ...
  <td><center><h4>Universidad de El Salvador<br>Facultad Multidisciplinaria Paracentral </h4><h5>Listado de Estudiantes Inactivos  <br>
            ...
            <?php if($per->tipo=='estudiante') { ?>
              <?php foreach ($estudiantes as $element) { ?>
                <?php if($element->idpersona==$per->idpersona && $element->idcarrera==Auth::user()->idcarrera) { ?>
                  <?php if($element->persona->condicion==false) {?>
          <tr>
