...
<body>
  ...
  <td><center><h4>Universidad de El Salvador<br>Facultad Multidisciplinaria Paracentral </h4><h5>Información de Estudiante</h5> </center></td>
  ...
  <tr >
   ...
   <tr >
    ...
    <td > 
       <?php foreach($estudiantes as $est) {?>
        <?php if($est->idpersona==$persona->idpersona) {?> 
         <?= \Carbon\Carbon::parse($est->anioegreso )->format('d-m-Y') ?>
        <?php } ?> 
       <?php } ?> </td>
  </tr>
