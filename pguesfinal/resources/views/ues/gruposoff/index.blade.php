...
<div class="row" >
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" >
        <h3>Listado de Grupos  Finalizados
...
@endif              
  ...
  <thead><!--fila-->
                ...
                @foreach($grupos as $grup)
                @if($grup->condicion==false) {{--  filtra por carrera--}} 
                <tr>
                <td><?php echo $cont; $cont++ ?></td>
                <td hidden="">{{ $grup->idgrupo}}</td>                  
                    <td>{{ $grup->codigoG }}</td>
...
{{--este es solo para jefes--}}               
  ...
  <thead><!--fila-->
                ...
                @foreach($grupos as $grup)
                 @if($grup->idcarrera==Auth::user()->idcarrera &&$grup->condicion==false)  {{--filtra por carrera--}} 
                <tr>
                <td><?php echo $cont; $cont++ ?></td>
                <td hidden="">{{ $grup->idgrupo}}</td>                  
                    <td>{{ $grup->codigoG }}</td>
