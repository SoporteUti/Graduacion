<div class="modal fade" id="modal-create">
  <div class="modal-dialog">
    <div class="modal-content">
      {!! Form::open(array('action'=>array('UsuarioController@addols'),'route'=>['ues.usuario.addrols'], 'method'=>'post', 'files' =>'true','id'=>'formCrear','class' => 'form-horizontal')) !!}
      ...
      <div class="modal-body">
          <div class="row">
            ...
            {!! Form::label('nombre', 'Docente', ['class'=>'control-label col-sm-2']) !!}
            <div class="col-sm-8">
          ...
          <div class="row">
            <div class="form-group">
              {!! Form::label('carreraselect', 'Carrera', ['class'=>"col-sm-2 control-label"]) !!}
              <div class="col-sm-8">
          ...
          <div class="row">
            <div class="form-group">
              {!! Form::label('rolselect', 'Rol', ['class'=>"col-sm-2 control-label"]) !!}
              <div class="col-sm-8">
