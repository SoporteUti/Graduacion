...
<div class="panel  panel-info">
        <div class="panel-heading"> <h5><img src="{{URL::asset('img/historial.png')}}" width="20px" height="20px"></img>Historial de Usuario</h5> </div>
  ...
  <tr>             
    ...
    <div class="panel">
<div class="panel-heading" style="background:#00a65a; color:white"> <strong><h4><img src="{{URL::asset('img/actividades.png')}}" width="20px" height="20px"></img> Actividades</h4> </strong></div>
