...
{!!Form::open (array('url'=>'ues/estudiantesPera','method'=>'POST','autocomplete'=>'off', 'files' =>'true'))!!}
			{{Form::token()}}
			 ...
			 <div class="table-responsive">
				<table class="table table-striped table-bordered table-condensed table-hover" id="estudiantes">
                    ...
                    <td>
                       ...
                       @include('ues.estudiantesPera.ver')
                       @endif
                    @endif
                      @endforeach
...
function ventana(id)
{
ventana1=window.open("{{ url('/listaEstPera/')  }}" ,'scrollbars=yes,width=800,height=1000,titlebar=no'); 
}
</script>
@endsection
