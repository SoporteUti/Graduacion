...
{!!Form::open (array('url'=>'ues/docentes','method'=>'POST','autocomplete'=>'off', 'files' =>'true'))!!}
      {{Form::token()}}
       ...
       <div class="table-responsive">
        <table class="table table-striped table-bordered table-condensed table-hover" id="docentes">
          ...
          <tr><!--fila simple-->
            ...
            <td hidden="">{{ $doc->iddocente}}</td><!--celda sencilla-->
            <td>{{ $per->nombres }}</td><!--celda sencilla-->
            <td>{{ $per->apellidos }}</td><!--celda sencilla-->
            <td>{{ $per->telefono }}</td><!--celda sencilla-->
            <td>{{ $per->correo }}</td><!--celda sencilla-->


                        <td> @if($per->condicion==true) Activo 
                         @else
                        Inactivo
...
@if($per->condicion==true)
                        <a href="" data-target="#modal-edit-{{$per->idpersona}}" data-toggle="modal">
                       ...
                       <a href="" data-target="#modal-ver-{{$per->idpersona}}" data-toggle="modal"><button class="btn btn-success"><i class="fa fa-eye"></i></button></a>
                        <a href="" data-target="#modal-delete-{{$per->idpersona}}" data-toggle="modal"><button class="btn btn-danger"><i class="fa fa-caret-square-o-down"></i></button></a>

                        <a><button onclick="ventanaP('{{ $per->idpersona}}')" class="btn btn-primary"><i class="fa fa-file-pdf-o" ></i></button></a>
@else
                       ...
                       <a href="" data-target="#modal-ver-{{$per->idpersona}}" data-toggle="modal"><button class="btn btn-success"><i class="fa fa-eye"></i></button></a>
                        ...
                        <a href="" data-target="#modal-modalup-{{$per->idpersona}}" data-toggle="modal"><button class="btn btn-info"><i class="fa fa-caret-square-o-up"></i></button></a>
    ...
    @endif        
                     ...
                     @include('ues.docentes.ver')
                    @include('ues.docentes.edit')
                     @include('ues.docentes.modal')
                    @include('ues.docentes.modalup') 
                    @endif
          @endforeach
          @endforeach
        </table>
...
function ventana(id)
{
ventana1=window.open("{{ url('/listaDoc/')  }}"  ,'scrollbars=yes,width=800,height=1000,titlebar=no'); 
}
</script>
...
{
ventana1=window.open("{{ url('/listaDocI/')  }}"  ,'scrollbars=yes,width=800,height=1000,titlebar=no'); 
}
</script>
...
{
ventana1=window.open("{{ url('ues/docentes/perfilDoc') }}"+"/"+ id,'scrollbars=yes,width=800,height=1000,titlebar=no'); 
}
</script>
...
@if(Session::has('message'))
    ...
    <script>
      $("#modal-ver-{{$per->idpersona}}").on('hidden.bs.modal', function() {
        DataTableCargaDatos();
    });
    </script>
