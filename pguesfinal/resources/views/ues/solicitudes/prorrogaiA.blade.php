...
@foreach ($etapaactiva as $ea) 
                     ...
                     @if ($ea->idgrupo==$gru->idgrupo && $ea->estado==1)
...
<h >Por lo que solicitamos la pr&oacute;rroga interna n&uacute;mero {{$numerosoli}} para completar  la etapa {{$etapa}} a partir de  {{ \Carbon\Carbon::parse($pi->fechaInicio )->format('d-m-Y')}} hasta {{ \Carbon\Carbon::parse($pi->fechaFinal)->format('d-m-Y')}}.</h>
