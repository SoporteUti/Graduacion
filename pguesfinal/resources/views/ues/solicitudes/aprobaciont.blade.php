...
<h5 align="right">
{{$en->ciudad}}, <?php echo date('d');?> de <?php  $meses = array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre" ); echo $meses[idate('m')-1]; ?> de <?php echo date('Y');?></h5>
<p align="justify">
...
<br>Presente</h></p>
<p align="justify"><h ><br>{{$en->saludo}}</h></p>
<p align="justify">
...
<h >
	...
	@if($gru->codigoG==$codigo)
<p align="justify"><h>{{$en->infogrupo}}{{$gru->codigoG}}:</h></p>	
	@endif
	@endforeach
...
<p align="justify"><h >{{$en->infoad}}</h></p>


<p align="justify"><h >{{$en->despedida}}</h></p>
