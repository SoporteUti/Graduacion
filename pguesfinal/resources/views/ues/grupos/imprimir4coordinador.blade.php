...
{{Form::Open(array('action'=>array('solicitudpicController@sRatificaciondeTribunalCoordinador'),'route'=>['ues.solicitudesconta.sRatificaciondeTribunalCoordinador'], 'method'=>'post', 'files' =>'true'))}}
