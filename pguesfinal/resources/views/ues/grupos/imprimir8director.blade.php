<div class="modal fade modal-slide-in-right" aria-hidden="true" 
 role="dialog" tabindex="-1"  id="imprimird-8-{{$gs->idgrupsol}}">
{{Form::Open(array('action'=>array('solicitudController@imprepabandonoDirector'),'route'=>['ues.solicitudes.imprepabandonoDirector'], 'method'=>'post', 'files' =>'true'))}}
