...
role="dialog" tabindex="-1"  id="imprimird-6-{{$gs->idgrupsol}}">
{{Form::Open(array('action'=>array('solicitudpicController@spicontaDirector'),'route'=>['ues.solicitudesconta.spicontaDirector'], 'method'=>'post', 'files' =>'true'))}}
