    ...
    role="dialog" tabindex="-1" id="verpdfs1-{{$gs->idgrupsol}}">
  
    <div class="modal-dialog">
      {{Form::Open(array('action'=>array('solicitudController@registrarase'),'route'=>['ues.solicitudes.registrarase'], 'method'=>'post', 'files' =>'true'))}}
