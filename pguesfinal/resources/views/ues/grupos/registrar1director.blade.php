    ...
    role="dialog" tabindex="-1" id="registrard-1-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudController@registrardocenviados'),'route'=>['ues.solicitudes.registrardocenviados'], 'method'=>'post', 'files' =>'true'))}}
