    ...
    role="dialog" tabindex="-1" id="registrard-10-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudController@registrardocratiresulimp'),'route'=>['ues.solicitudes.registrarimp'], 'method'=>'post', 'files' =>'true'))}}
