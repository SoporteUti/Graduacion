...
<div class="modal fade" id="imprimird-9-{{$gs->idgrupsol}}">
{{Form::Open(array('action'=>array('solicitudController@imprimir9director'),'route'=>['ues.solicitudes.imprimir9director'], 'method'=>'post', 'files' =>'true'))}}
