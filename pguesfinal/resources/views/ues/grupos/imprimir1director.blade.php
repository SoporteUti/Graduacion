...
role="dialog" tabindex="-1" id="imprimird-1-{{$gs->idgrupsol}}">
{{Form::Open(array('action'=>array('solicitudController@imprimiraprovaciontd'),'route'=>['ues.solicitudes.imprimiraprovaciontd'], 'method'=>'post', 'files' =>'true'))}}
<div class="modal-dialog">
 ...
 <div  hidden="" class="col-lg-12 col-md-12 col-xs-12 col-sm-12" >
    ...
    <div class="modal-footer">
      ...
      <button type="submit" onclick="rel();" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir</button>
    </div>
  </div>
</div>
{{Form::Close()}}
