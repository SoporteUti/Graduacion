    ...
    role="dialog" tabindex="-1" id="registrard-6-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudpicController@registrardocmodtema'),'route'=>['ues.solicitudes.registrardocmodtema'], 'method'=>'post', 'files' =>'true'))}}
