<div class="modal fade modal-slide-in-right" aria-hidden="true" 
 role="dialog" tabindex="-1"  id="imprimirc-4-{{$gs->idgrupsol}}">
{{Form::Open(array('action'=>array('solicitudpicController@sRatificaciondeTribunalAsesor'),'route'=>['ues.solicitudesconta.sRatificaciondeTribunalAsesor'], 'method'=>'post', 'files' =>'true'))}}
...
<button  type="button" class="btn btn-danger pull-left" data-dismiss="modal"><i class="fa fa-arrow-circle-left"></i>  Cerrar</button>
