    ...
    role="dialog" tabindex="-1" id="imprimird-5-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudController@impratiResulD'),'route'=>['ues.solicitudes.impratiResulD'], 'method'=>'post', 'files' =>'true'))}}
