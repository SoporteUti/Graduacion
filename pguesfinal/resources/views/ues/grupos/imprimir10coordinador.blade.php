...
<div class="modal fade" id="imprimirc-10-{{$gs->idgrupsol}}">
{{Form::Open(array('action'=>array('solicitudController@imprimir10coordinador'),'route'=>['ues.solicitudes.imprimir10coordinador'], 'method'=>'post', 'files' =>'true'))}}
