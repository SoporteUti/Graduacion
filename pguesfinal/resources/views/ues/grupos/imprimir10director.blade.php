    ...
    role="dialog" tabindex="-1" id="imprimird-10-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudController@imprimir10director'),'route'=>['ues.solicitudes.imprimir10director'], 'method'=>'post', 'files' =>'true'))}}
