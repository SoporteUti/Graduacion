...
<div class="modal fade" id="imprimird-3-{{$gs->idgrupsol}}">
{{Form::Open(array('action'=>array('solicitudController@imprimir3director'),'route'=>['ues.solicitudes.imprimir3director'], 'method'=>'post', 'files' =>'true'))}}
