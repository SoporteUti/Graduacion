                ...
                <td >Cancelado </td> 
                  ...
                  @endforeach
                   ...
                   <td >
                    ...
                    <a href=""  data-target="#imprimird-{{$sol->idsolicitud}}-{{$gs->idgrupsol}}" data-toggle="modal">
                    <button  class="btn btn-warning"><i class="fa fa-print"></i></button></a>


                     @if($gs->estado==0 && $gs->condicion==true || $gs->estado==1 || $gs->estado==7)
                  <a href=""   data-target="#registrard-{{$sol->idsolicitud}}-{{$gs->idgrupsol}}" data-toggle="modal">
