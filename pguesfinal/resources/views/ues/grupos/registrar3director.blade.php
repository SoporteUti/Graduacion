    ...
    role="dialog" tabindex="-1" id="registrard-3-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudController@registrarprorrogajd'),'route'=>['ues.solicitudes.registrarprorrogajd'], 'method'=>'post', 'files' =>'true'))}}
