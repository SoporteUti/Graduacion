                                        ...
                                        <select name="dept" id="dept" class="form-inline form-control">
                                            ...
                                            @foreach ($departamento as $depto)
                                                ...
                                                @if ($depto->condicion == 1)
                                                    ...
                                                    <option value="{{ $depto->iddepartamento }}">{{ $depto->nombre }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        </select>
                                                ...
                                                @foreach ($integrantes as $int)
                                                    @if ($per->idpersona == $int->idpersona && $int->idcarrera == Auth::user()->idcarrera)
                                                        @if ($per->condicion == true)
                                                            <option value="{{ $int->idestudiante }}">
                                                                {{ $int->carnet . ' ' . $per->nombres . ' ' . $per->apellidos }}
                                                            </option>
                                                        @endif
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="tiposc" id="tiposc" class="chosen-select form-control">
                                            ...
                                            @foreach ($tipoasesor as $asesor)
                                                <option value="{{ $asesor->idtipoasesor }}">{{ $asesor->tipoasesor }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                ...
                <table class="table table-striped table-bordered table-condensed table-hover" id="grupo">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($grup->condicion == true)
                                            ...
                                            <a href="" data-target="#modal-ver-{{ $grup->idgrupo }}"
                                                data-toggle="modal"><button class="btn btn-success " onclick="btncod"><i
                                                        class="fa fa-eye"></i></button></a>

                                            <a href="{{ route('ues.grupos.vista_director', $grup->idgrupo) }}"><button
                                ...
                                <td>
                                    ...
                                    @if ($grup->condicion == true)
                                        ...
                                        <a href="" data-target="#modal-ver-{{ $grup->idgrupo }}"
                                            data-toggle="modal"><button class="btn btn-success " onclick="btncod"><i
                                                    class="fa fa-eye"></i></button></a>
                                        <a href="" data-target="#modal-delete-{{ $grup->idgrupo }}"
                                            data-toggle="modal"><button class="btn btn-danger"><i
                                                    class="fa fa-caret-square-o-down"></i></button></a>
                                        <a href="{{ route('ues.grupos.steps', $grup->idgrupo) }}"><button
                                                class="btn btn-info"><i class="fa fa-folder-open"></i></button></a>
                                    ...
                                    @else
                                        ...
                                        <a href="" data-target="#modal-ver-{{ $grup->idgrupo }}"
                                            data-toggle="modal"><button class="btn btn-success"><i
                                                    class="fa fa-eye"></i></button></a>
                                        <a href="" data-target="#modal-modalup-{{ $grup->idgrupo }}"
                   ...
                   @include('ues.grupos.modalup') -->
                    ...
                    @if (Auth::user()->idrol == 2)
                        ...
                        @foreach ($grupos as $grup)
                            @if ($grup->idcarrera == Auth::user()->idcarrera && $grup->condicion == true)
                                {{-- filtra por carrera --}}
                                <tr>
                                    <td><?php echo $cont;
                                    $cont++; ?></td>
                                        ...
                                        @if ($grup->idcarrera == Auth::user()->idcarrera && $grup->condicion == true)
                                            ...
                                            @if (Auth::user()->idpersona == $persona->idpersona && $persona->idpersona == $docente->idpersona && $docente->iddocente == $asesor->iddocente && $asesor->idgrupo == $grup->idgrupo)
                                                <tr>
                                                    ...
                                                    <td>{{ \Carbon\Carbon::parse($grup->fecharegistro)->format('d-m-Y') }}
                                                    </td>
                                                    <td>
                                                        @if ($grup->condicion == true)
                                                            Activo
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($grup->condicion == true)
                                                            ...
                                                            <a
                                                                href="{{ route('ues.grupos.vista_asesor', $grup->idgrupo) }}"><button
                    ...
                    @if (Auth::user()->idrol == 6)
                        ...
                        @foreach ($personas as $persona)
                            ...
                            @foreach ($estudiantes as $est)
                                <!--personas-->
                                @foreach ($mostraintegrante as $integrante)
                                    <!--integrantes-->
                                    @foreach ($grupos as $grup)
                                        @if ($grup->idcarrera == Auth::user()->idcarrera)
                                            {{-- filtra por carrera --}}
                                            {{-- @foreach ($rol_carrera as $rlc) --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($grup->condicion == true)
                                                            ...
                                                            <a
                                                                href="{{ route('ues.grupos.vista_estudiante', $grup->idgrupo) }}"><button
                                                                    class="btn btn-info"><i
                                                                        class="fa fa-folder-open"></i></button></a>
