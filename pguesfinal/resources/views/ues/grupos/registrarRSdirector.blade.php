    ...
    role="dialog" tabindex="-1" id="registrard-5-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudController@registrardocratiresul'),'route'=>['ues.solicitudes.registrardocratiresul'], 'method'=>'post', 'files' =>'true'))}}
