    ...
    role="dialog" tabindex="-1" id="registrard-2-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudController@registrardocpinterna'),'route'=>['ues.solicitudes.registrardocpinterna'], 'method'=>'post', 'files' =>'true'))}}
