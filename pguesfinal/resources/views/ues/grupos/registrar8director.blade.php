    ...
    role="dialog" tabindex="-1" id="registrard-8-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudController@registrar8director'),'route'=>['ues.solicitudes.registrar8director'], 'method'=>'post', 'files' =>'true'))}}
...
<div hidden="" class="col-lg-12 col-md-12 col-xs-12 col-sm-12">  
          <div class="form-group"> 
           ...
           @foreach($ni as $ni)
                ...
                <input readonly=""  name="estudianteselec"  id="estudianteselec" type="text" class="form-control"    value="{{$est->idestudiante}}">
                @endif
                @endforeach
                @endif
                @endforeach
