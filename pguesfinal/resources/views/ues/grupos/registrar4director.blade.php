    ...
    role="dialog" tabindex="-1" id="registrard-4-{{$gs->idgrupsol}}">
    {{Form::Open(array('action'=>array('solicitudpicController@registrardoctribcal'),'route'=>['ues.solicitudes.registrardoctribcal'], 'method'=>'post', 'files' =>'true'))}}
