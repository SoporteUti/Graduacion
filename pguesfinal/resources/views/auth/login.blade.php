...
.hola{
 ...
 <body style="background-color: #666666;">
  <div class="limiter">
    ...
    <form class="login100-form validate-form hola" role="form" method="POST" action="{{ url('/login') }}">



                        {{ csrf_field() }}
                        <p class="centrado"> <img src="{{asset('img/ic_launcher144.png') }}" text-align="center" width="100px" height="100px"  ></img></p>
           ...
           <span class="login100-form-title p-b-43 offset-6">
            Acceso al sistema
                        ...
                        <label>Correo</label>
                        <div {{ $errors->has('email') ? ' has-error' : '' }} data-validate = "Valid email is required: ex@abc.xyz">
            <input id="email" class="form-inline form-control" type="email" name="email"  value="{{ old('email') }}">
