...
.hola{
 ...
 <body style="background-color: #666666;">
  <div class="limiter">
    ...
    <form class="login100-form validate-form hola" role="form" method="POST" action="<?php echo e(url('/login')); ?>">



                        <?php echo e(csrf_field()); ?>

                        <p class="centrado"> <img src="<?php echo e(asset('img/ic_launcher144.png')); ?>" text-align="center" width="100px" height="100px"  ></img></p>
           ...
           <span class="login100-form-title p-b-43 offset-6">
            Acceso al sistema
                        ...
                        <label>Correo</label>
                        <div <?php echo e($errors->has('email') ? ' has-error' : ''); ?> data-validate = "Valid email is required: ex@abc.xyz">
            <input id="email" class="form-inline form-control" type="email" name="email" onblur="fill()" value="<?php echo e(old('email')); ?>">
          ...
          <div <?php echo e($errors->has('password') ? ' has-error' : ''); ?> data-validate="Password is required">
            <input class="form-inline form-control" type="password" id="password" name="password">
             ...
             <?php if($errors->has('password')): ?>
                        ...
                        <div <?php echo e($errors->has('select-carrera') ? ' has-error' : ''); ?>>
                            <label for="select-carrera">Carrera</label>

                          
                                <select class="form-inline form-control" name="select-carrera" onchange="fill_roles()" id="select-carrera" >
                        ...
                        <div <?php echo e($errors->has('select-rol') ? ' has-error' : ''); ?>>
        ...
        <div class="login100-more" style="background-image : url('img/home-bg.jpg');">
        </div>
      </div>
    </div>
  </div>
