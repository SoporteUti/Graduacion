...
<div class="modal fade" id="imprimirc-3-<?php echo e($gs->idgrupsol); ?>">
<?php echo e(Form::Open(array('action'=>array('solicitudController@imprimir3coordinador'),'route'=>['ues.solicitudes.imprimir3coordinador'], 'method'=>'post', 'files' =>'true'))); ?>
