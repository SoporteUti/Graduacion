...
<h >En atenci&oacute;n a la solicitud presentada por el Coordinador General de Trabajos de Graduaci&oacute;n del Departamento de <?php echo e($depto); ?>, <?php echo e($coor); ?> y con el Visto Bueno del Jefe del Departamento de <?php echo e($depto); ?>, <?php echo e($jefe); ?> y <?php foreach($enunciado as $en): ?>
	<?php if($en->idsolicitud==3 && $en->idrol==4): ?>
	<?php echo e($en->enunciado); ?>

	<?php endif; ?>
	<?php endforeach; ?>, tengo a bien solicitarles muy respetuosamente la pr&oacute;rroga número <?php echo e($numerosoli); ?> al trabajo de graduaci&oacute;n que se detalla a continuaci&oacute;n:</h>
