...
role="dialog" tabindex="-1"  id="eliminars-<?php echo e($gs->idgrupsol); ?>">
<?php echo e(Form::Open(array('action'=>array('solicitudController@eliminars'),'route'=>['ues.solicitudes.eliminars'], 'method'=>'post', 'files' =>'true'))); ?>
