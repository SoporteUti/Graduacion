        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <?php echo Form::open(['route'=>['ues.grupos.asistencia',$grupos->idgrupo],'method'=>'POST']); ?>

                    <div class="row">
                        <div class='col-sm-8'>
                            <div class="form-group">
                                <?php echo Form::label('fecha_asistencia', 'Fecha Asesoria:', ['class'=>"control-label"]); ?>
                    ...
                    <div class="row">
                        <div class='col-sm-6'>
                            <div class="form-group">
                                <?php echo Form::label('hora_inicio', 'Hora Inicio:', ['class'=>"control-label"]); ?>
                        ...
                        <div class='col-sm-6'>
                            <div class="form-group">
                                <?php echo Form::label('hora_final', 'Hora Final:', ['class'=>"control-label"]); ?>
