...
<div class="modal fade" id="imprimirc-9-<?php echo e($gs->idgrupsol); ?>">
<?php echo e(Form::Open(array('action'=>array('solicitudController@imprimir9coordinador'),'route'=>['ues.solicitudes.imprimir9coordinador'], 'method'=>'post', 'files' =>'true'))); ?>
