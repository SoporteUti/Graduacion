...
<h >El motivo de la presente es notificarle que el grupo que se detalla no podrá completar la etapa en el tiempo correspondiente. Remito a usted los datos del grupo que solicita la prórroga  interna número <?php echo e($numerosoli); ?> de la etapa <?php echo e($etapa); ?>  del   Proyecto  de Trabajo de Graduación:</h>
...
<p align="justify"><h>		Tema:</h>
 ...
 <?php foreach($proint as $pi): ?>
	...
	<palign="justify">
	<h >La prórroga que solicitan es a partir de <?php echo e(\Carbon\Carbon::parse($pi->fechaInicio )->format('d-m-Y')); ?> hasta <?php echo e(\Carbon\Carbon::parse($pi->fechaFinal)->format('d-m-Y')); ?>.</h>
	</p>
	<?php endif; ?>
 <?php endforeach; ?>
