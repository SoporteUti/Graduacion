...
<script src="<?php echo e(asset('js/jQuery-2.1.4.min.js')); ?>"></script>
	...
	<div class="row" >
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" >
			<h3>Listado de Estudiantes   <button data-backdrop="static" data-keyboard="false" class="btn btn-success" data-toggle="modal" data-target="#modalagregarestudiante">Nuevo</button>
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			 <div class="table-responsive">
				<table  class="table table-striped table-bordered table-condensed table-hover" id="alumnos" >
					<thead><!--fila-->
            <tr>
						<!--<th hidden=""></th>celda -->
            <th>N°</th>
            ...
            <tbody>
                    ...
                    <td hidden=""><?php echo e($per->idpersona); ?></td>	
...
<?php if($per->condicion==true): ?>
                      ...
                      <!--  <a href="<?php echo e(route('ues.estudiantes.stepsEst',$per->idpersona)); ?>"  ><button class="btn btn-info"><i class="fa fa-info-circle" style="font-size:18px;color:green"></i></button></a> -->
...
<?php else: ?>
    ...
    <?php endif; ?>       		
                    ...
                    <?php echo $__env->make('ues.estudiantes.ver', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo $__env->make('ues.estudiantes.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                     <?php echo $__env->make('ues.estudiantes.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                     <?php echo $__env->make('ues.estudiantes.modalup', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                     <?php endif; ?>
                        <?php endforeach; ?>
                     <?php endif; ?>
					<?php endforeach; ?>
