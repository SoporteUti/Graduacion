    ...
    role="dialog" tabindex="-1" id="registrard-6-<?php echo e($gs->idgrupsol); ?>">
    <?php echo e(Form::Open(array('action'=>array('solicitudpicController@registrardocmodtema'),'route'=>['ues.solicitudes.registrardocmodtema'], 'method'=>'post', 'files' =>'true'))); ?>

    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="background:#00a65a; color:white>
          <h4 class="modal-title">Registrar Documentación - Modificación de Tema</h4>
        </div>
     ...
     <div  hidden="" class="col-lg-12 col-md-12 col-xs-12 col-sm-12" >
          ...
          <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" >
                <div class="form-group"> 
                <label>Registrar Documentos Recibidos JD</label>
                    <div class="input-group">                   
                        <span class="input-group-addon"><i class="fa fa-info"></i></span>
    ...
    <?php endif; ?>
         ...
         <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" >
                <div class="form-group"> 
                <label>Registrar Documentos Enviados JD</label>
                    <div class="input-group">                   
                        <span class="input-group-addon"><i class="fa fa-info"></i></span>
