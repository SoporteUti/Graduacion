...
<?php foreach($enunciado as $en): ?>
	<?php if($en->idsolicitud==5 && $en->idrol==3): ?>
	<?php echo e($en->enunciado); ?>

	<?php endif; ?>
	<?php endforeach; ?>, le solicitamos  que interponga sus buenos oficios ante la Junta Directiva de ésta Facultad para que sean ratificados los resultados obtenidos en los  trabajos de graduaci&oacute;n.</h></p>

<?php foreach($grupo as $gru): ?>
 <?php if($gru->codigoG==$codigo): ?>
  <p align="justify"><h>C&oacute;digo: <?php echo e($gru->codigoG); ?></h>	
