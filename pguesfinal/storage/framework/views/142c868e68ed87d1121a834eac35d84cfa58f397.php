<div class="modal fade modal-slide-in-right" aria-hidden="true" 
 role="dialog" tabindex="-1"  id="imprimirc-6-<?php echo e($gs->idgrupsol); ?>">
<?php echo e(Form::Open(array('action'=>array('solicitudpicController@spicontaAsesor'),'route'=>['ues.solicitudesconta.spicontaAsesor'], 'method'=>'post', 'files' =>'true'))); ?>
            ...
            <label>Motivo</label>
                <div class="input-group">                   
                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                     ...
                     <?php foreach($cambiotema as $ct): ?>         
                        <?php if( $gs->idgrupsol == $ct->idgrupsol): ?> 
                    <input readonly="" name="motivo"  value="<?php echo e($ct->motivo); ?>" id="motivo" class="form-control" >
                     <?php endif; ?>
                    <?php endforeach; ?>
