...
<h>			Tipo de Proceso de graduación:</h>
 ...
 <?php foreach($proint as $pi): ?>
	<?php if($gruposol==$pi->idgrupsol): ?>  
	<palign="justify">
	<h >Por lo que solicitamos prórroga a partir de <?php echo e(\Carbon\Carbon::parse($pi->fechaInicio )->format('d-m-Y')); ?> hasta <?php echo e(\Carbon\Carbon::parse($pi->fechaFinal)->format('d-m-Y')); ?>.</h>
	</p>
	<?php endif; ?>				 
 <?php endforeach; ?>
