                  ...
                  <?php endforeach; ?>
                   <?php endif; ?>
                    ...
                    <?php endif; ?>
                        ...
                        <td ><a disabled="true" href=""  data-target="#imprimirc-<?php echo e($sol->idsolicitud); ?>-<?php echo e($gs->idgrupsol); ?>" data-toggle="modal" >
                          <button  class="btn btn-warning" disabled="true"><i class="fa fa-print"></i></button></a></td>
