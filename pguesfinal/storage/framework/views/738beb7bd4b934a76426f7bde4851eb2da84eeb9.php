        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" > 
          <div class="form-group"> 
            <label>Institución</label>
                <div class="input-group">                   
                    <span class="input-group-addon"><i class="fa fa-database"></i></span>
                    <input id="institucion" disabled type="text"  value="<?php echo e($grup->institucion); ?>"  class="form-control" name="institucion"  placeholder="Ingresar Institución">
                </div>          
          </div>
          </div>
            ...
            <label>N° Acuerdo de Aprobación/Denegado </label>
                <div class="input-group">                   
                    <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                            ...
                            <input id="" disabled type="text"  value="<?php echo e($na->nacuerdo); ?>"  class="form-control" name="">
