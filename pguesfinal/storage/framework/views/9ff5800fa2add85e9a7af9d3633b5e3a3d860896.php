...
<div class="row" >
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" >
        ...
        <?php if(Auth::user()->idrol!=5 && Auth::user()->idrol!=6 && Auth::user()->idrol!=4
        && Auth::user()->idrol!=2 && Auth::user()->idrol!=1): ?>
         <!-- <button class="btn btn-success" data-toggle="modal" data-target="#modalagregargrupo">Nuevo</button>   -->
         <?php endif; ?>
