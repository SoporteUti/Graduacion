...
<?php $__env->startSection('contenido'); ?>
  ...
  <?php echo Form::open(['route'=>['ues.estudiantes.pdfestudiantes'],'method'=>'POST']); ?>
           ...
           <div class="form-group"> 
            ...
            <div class="input-group">                   
                ...
                <option value="-1">[Seleccione]
                       ...
                       <?php foreach($ciclo as $cl): ?>


                        <option value="<?php echo e($cl->ciclo); ?>" ><?php echo e($cl->ciclo); ?></option>
      ...
      <table class="table table-striped table-bordered table-condensed table-hover" id="est">
        ...
        <tbody>
          ...
          <?php foreach($estudiante as $element): ?>
           <?php if($element->idcarrera==Auth::user()->idcarrera): ?>  <?php /*filtra por carrera*/ ?> 
          <tr>
