    ...
    role="dialog" tabindex="-1" id="registrard-1-<?php echo e($gs->idgrupsol); ?>">
    <?php echo e(Form::Open(array('action'=>array('solicitudController@registrardocenviados'),'route'=>['ues.solicitudes.registrardocenviados'], 'method'=>'post', 'files' =>'true'))); ?>

    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="background:#00a65a; color:white>
          <h4 class="modal-title">Registrar Documentación - Aprovación de tema</h4>
        </div>
