...
<h >Por lo que solicitamos la pr&oacute;rroga interna n&uacute;mero <?php echo e($numerosoli); ?> para completar  la etapa <?php echo e($etapa); ?> a partir de  <?php echo e(\Carbon\Carbon::parse($pi->fechaInicio )->format('d-m-Y')); ?> hasta <?php echo e(\Carbon\Carbon::parse($pi->fechaFinal)->format('d-m-Y')); ?>.</h>
