...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <link rel="stylesheet" href="<?php echo e(asset('css/AdminLTE.min.css')); ?>">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
     ...
     <link rel="shortcut icon" href="<?php echo e(asset('img/ic_launcher48.png')); ?>">
              ...
              <ul class="nav navbar-nav">
                ...
                <aside class="main-sidebar">
                    ...
                    <ul class="sidebar-menu">
                      ...
                      <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                          ...
                          <li><a href="<?php echo e(url('ues/gruposoff')); ?>"><i class="fa fa-circle-o"></i> Grupos Finalizados</a></li>
                        </ul>
                      </li>
                      <?php endif; ?>
                      ...
                      <li class="treeview">
                        ...
                        <li><a href="<?php echo e(url('ues/categorias')); ?>"><i class="fa fa-circle-o"></i> Categor&iacute;as<!--</a></li><li><a href="<?php echo e(url('ues/etapas')); ?>"><i class="fa fa-circle-o"></i> Etapas</a></li>-->
                      </li><li><a href="<?php echo e(url('ues/nuevaetapa')); ?>"><i class="fa fa-circle-o"></i> Etapas</a></li>
                      </li><li><a href="<?php echo e(url('ues/solis')); ?>"><i class="fa fa-circle-o"></i> Solicitudes</a></li>
                    </ul>
                  </li>
                  <?php endif; ?>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li><a href="<?php echo e(url('ues/seguridad/bitacora')); ?>"><i class="fa fa-lock"></i> Bit&aacute;cora</a></li>

                    </ul>
                       <ul class="treeview-menu">
                <li><a href="<?php echo e(url('ues/backups')); ?>"><i class="fa fa-circle-o"></i>Respaldo</a></li>
...
<?php if(Auth::check() &&  Auth::user()->idrol==6): ?>
            ...
            <li class="treeview">
             ...
             <?php if(Auth::check() && Auth::user()->idrol==1 || Auth::user()->idrol==2 || Auth::user()->idrol==3 || Auth::user()->idrol==4 || Auth::user()->idrol==5 || Auth::user()->idrol==6): ?>
          <li>
              
              <a href="<?php echo e(url('ues/actividades')); ?>"><i class="fa fa-info-circle"></i><small class="label  bg-yellow">Acerca De...</small> </a>
          ...
          <?php endif; ?>
           ...
           <li>
              ...
              <a target="_blank" href="<?php echo e(url('img/M_U.pdf')); ?>"><i class="fa fa-question-circle"></i><small class="label  bg-light-blue">Ayuda.</small> </a>
          </li>
    ...
    <!-- Tab panes -->
     <!--   <div class="tab-content">
      ...
      <?php echo $__env->make('plantillas.access', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
