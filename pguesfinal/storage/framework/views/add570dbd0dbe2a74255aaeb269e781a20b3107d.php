                ...
                <aside class="main-sidebar">
                  ...
                  <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                      ...
                      <?php if(Auth::check() && Auth::user()->idrol==1 || Auth::user()->idrol==3): ?>
                      <li class="treeview">
                        <a href="#">
    ...
    <!-- Tab panes -->
     <!--   <div class="tab-content">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="http://www.fmp.ues.edu.sv/">UES-FMP</a>.</strong> Todos los derechos reservados.
      </footer>
