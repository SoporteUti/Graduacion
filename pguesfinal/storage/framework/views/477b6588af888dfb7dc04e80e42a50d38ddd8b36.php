<?php $__env->startSection('contenido'); ?>
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <h3>Listado de Grupos
                <?php if(Auth::user()->idrol != 5 && Auth::user()->idrol != 6 && Auth::user()->idrol != 4 && Auth::user()->idrol != 2): ?>
                    <button class="btn btn-success" data-backdrop="static" data-keyboard="false" data-toggle="modal"
                        data-target="#modalagregargrupo"><i class="fa fa-file-o"></i> Nuevo</button>
                <?php endif; ?>


                <?php if(Auth::user()->idrol != 6 && Auth::user()->idrol != 5 && Auth::user()->idrol != 4): ?>
                    <a><button onclick="ventana()" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> Activos
                        </button></a> <a><button onclick="ventanaI()" class="btn btn-primary"><i
                                class="fa fa-file-pdf-o"></i> Inactivos </button></a>

                <?php endif; ?>
                <?php if(Auth::user()->idrol == 4 || Auth::user()->idrol == 1): ?>
                    <a data-toggle="modal" data-target="#modal-estadisticos"><button class="btn btn-info"><i
                                class="fa fa-file-pdf-o"></i> Informaci&oacute;n </button></a>
            ...
            <div class="modal-content">
                <form id="gruppo" role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <select name="dept" id="dept" class="form-inline form-control">
                                            ...
                                            <?php foreach($departamento as $depto): ?>
                                                ...
                                                <?php if($depto->condicion == 1): ?>
                                                    ...
                                                    <option value="<?php echo e($depto->iddepartamento); ?>"><?php echo e($depto->nombre); ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-warning" type="reset" onclick="disable()"> <i class="fa fa-times"></i>
                            Cancelar</button>
    ...
    <?php echo Form::open(['route' => 'ues.grupos.store', 'method' => 'POST', 'autocomplete' => 'off', 'files' => 'true']); ?>
    ...
    <div id="modalagregargrupo" class="modal fade" role="dialog">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="codigoG" type="text" class="form-control" name="codigoG"
                                            onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="11"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="fecharegistro" name="fecharegistro"
                                            step="1" value="<?php echo date('d-m-y'); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div hidden="" class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="idcarrera" type="text" class="form-control" name="idcarrera"
                                            value="<?php echo e(Auth::user()->idcarrera); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                                        <textarea name="tema" id="tema" class="form-control rounded-0" rows=""
                                            placeholder="Ingresar el tema"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select data-placeholder="Seleccione Estudiantes" multiple
                                            class="form-control chosen-select" name="estudiantes[]">
                                            <option value="">[Seleccione]</option>
                                                ...
                                                <?php foreach($integrantes as $int): ?>
                                                    <?php if($per->idpersona == $int->idpersona && $int->idcarrera == Auth::user()->idcarrera): ?>
                                                        <?php if($per->condicion == true): ?>
                                                            <option value="<?php echo e($int->idestudiante); ?>">
                                                                <?php echo e($int->carnet . ' ' . $per->nombres . ' ' . $per->apellidos); ?>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-group"></i></span>
                                        <select data-placeholder="Seleccione Docentes" class="chosen-select form-control"
                                            name="docase" id="docase">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="tiposc" id="tiposc" class="chosen-select form-control">
                                            ...
                                            <?php foreach($tipoasesor as $asesor): ?>
                                                <option value="<?php echo e($asesor->idtipoasesor); ?>"><?php echo e($asesor->tipoasesor); ?>
                                    ...
                                    <span class="input-group-btn"><button type="button"
                                            class="btn btn-success btn-block btn-block btn-add-phone"><i
                                                class="glyphicon glyphicon-plus"></i>Agregar</button></span>
        ...
        ======================================-->
                    ...
                    <div class="modal-footer">
                        <button id="cancel1" type="button" class="btn btn-danger pull-left"
                            data-dismiss="modal">Cerrar</button>
                        <button id="cancel" class="btn btn-warning" type="reset"> <i class="fa fa-times"></i>
                            Cancelar</button>
                ...
                <table class="table table-striped table-bordered table-condensed table-hover" id="grupo">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($grup->condicion == true): ?>
                                            ...
                                            <a href="" data-target="#modal-ver-<?php echo e($grup->idgrupo); ?>"
                                                data-toggle="modal"><button class="btn btn-success " onclick="btncod"><i
                                                        class="fa fa-eye"></i></button></a>

                                            <a href="<?php echo e(route('ues.grupos.vista_director', $grup->idgrupo)); ?>"><button
                                                    class="btn btn-info"><i class="fa fa-folder-open"></i></button></a>


                                        <?php else: ?>

                                            <a href="" data-target="#modal-ver-<?php echo e($grup->idgrupo); ?>"
                                                data-toggle="modal"><button class="btn btn-success"><i
                                                        class="fa fa-eye"></i></button></a>
                   ...
                   <?php echo $__env->make('ues.grupos.modalup', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
                    ...
                    <?php if(Auth::user()->idrol == 1): ?>
                        ...
                        <?php foreach($grupos as $grup): ?>
                            <?php /* <?php if($grup->idcarrera == Auth::user()->idcarrera && $grup->condicion == true): ?>  filtra por carrera */ ?>
                            <tr>
                                <td><?php echo $cont;
                                $cont++; ?></td>
                                <td hidden=""><?php echo e($grup->idgrupo); ?></td>
                                ...
                                <td>
                                    ...
                                    <?php if($grup->condicion == true): ?>
                                        ...
                                        <a href="" data-target="#modal-ver-<?php echo e($grup->idgrupo); ?>"
                                            data-toggle="modal"><button class="btn btn-success " onclick="btncod"><i
                                                    class="fa fa-eye"></i></button></a>
                                        <a href="" data-target="#modal-delete-<?php echo e($grup->idgrupo); ?>"
                                            data-toggle="modal"><button class="btn btn-danger"><i
                                                    class="fa fa-caret-square-o-down"></i></button></a>
                                        <a href="<?php echo e(route('ues.grupos.steps', $grup->idgrupo)); ?>"><button
                                                class="btn btn-info"><i class="fa fa-folder-open"></i></button></a>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <a href="" data-target="#modal-ver-<?php echo e($grup->idgrupo); ?>"
                                            data-toggle="modal"><button class="btn btn-success"><i
                                                    class="fa fa-eye"></i></button></a>
                                        <a href="" data-target="#modal-modalup-<?php echo e($grup->idgrupo); ?>"
                                            data-toggle="modal"><button class="btn btn-info"><i
                                                    class="fa fa-caret-square-o-up"></i></button></a>
                                        <a href="<?php echo e(route('ues.grupos.steps', $grup->idgrupo)); ?>"><button
                                                class="btn btn-info"><i class="fa fa-folder-open"></i></button></a>
                   ...
                   <?php echo $__env->make('ues.grupos.modalup', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
                    ...
                    <?php if(Auth::user()->idrol == 2): ?>
                        ...
                        <?php foreach($grupos as $grup): ?>
                            <?php if($grup->idcarrera == Auth::user()->idcarrera && $grup->condicion == true): ?>
                                <?php /* filtra por carrera */ ?>
                                <tr>
                                    <td><?php echo $cont;
                                    $cont++; ?></td>
                                    <td hidden=""><?php echo e($grup->idgrupo); ?></td>
                                        ...
                                        <?php if($grup->idcarrera == Auth::user()->idcarrera && $grup->condicion == true): ?>
                                            ...
                                            <?php if(Auth::user()->idpersona == $persona->idpersona && $persona->idpersona == $docente->idpersona && $docente->iddocente == $asesor->iddocente && $asesor->idgrupo == $grup->idgrupo): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(\Carbon\Carbon::parse($grup->fecharegistro)->format('d-m-Y')); ?>
                                                        ...
                                                        <?php if($grup->condicion == true): ?>
                                                            ...
                                                            <a href="" data-target="#modal-ver-<?php echo e($grup->idgrupo); ?>"
                                                                data-toggle="modal"><button class="btn btn-success "
                                                                    onclick="btncod"><i class="fa fa-eye"></i></button></a>



                                                            <a
                                                                href="<?php echo e(route('ues.grupos.vista_asesor', $grup->idgrupo)); ?>"><button
                    ...
                    <?php if(Auth::user()->idrol == 6): ?>
                        ...
                        <?php foreach($personas as $persona): ?>
                            ...
                            <?php foreach($estudiantes as $est): ?>
                                <!--personas-->
                                <?php foreach($mostraintegrante as $integrante): ?>
                                    <!--integrantes-->
                                    <?php foreach($grupos as $grup): ?>
                                        <?php if($grup->idcarrera == Auth::user()->idcarrera): ?>
                                            <?php /* filtra por carrera */ ?>
                                            <?php /* <?php foreach($rol_carrera as $rlc): ?> */ ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if($grup->condicion == true): ?>
                                                            ...
                                                            <a
                                                                href="<?php echo e(route('ues.grupos.vista_estudiante', $grup->idgrupo)); ?>"><button
                                                                    class="btn btn-info"><i
                                                                        class="fa fa-folder-open"></i></button></a>
        ...
        $(function() {
            ...
            $('.btn-add-phone').click(function() {
                ...
                $('.asesorlst').append('<br>' +
                    ...
                    '">' +
                    '<input type="hidden" name="asesor[' + index + '][idtipoasesor]" value="' +
                    idtipoasesor + '">' +
                    '<span class="input-group-addon"><i class="fa fa-list"></i></span>' +
                    '<input name="asesor[' + index +
                    '][number]" class="form-control" placeholder="9999 9999" id="phone" value="' +
                    nombreasesor + ' - ' + tipoasesor + '">' +
                    '<span class="input-group-btn">' +
                    '<button type="button" class="btn btn-danger btn-remove-phone"><i class="glyphicon glyphicon-remove"></i> Eliminar</button>' +
                    '</span>' + '</div>'
                );
            });
        });
                ...
                if (id_depto != -1) {
                    ...
                    axios.get(url.replace(':id', id_depto))
                        .then(function(response) {
                            ...
                            sel.options[sel.options.length] = new Option("[Seleccione]", "-1", false,
                                false);
