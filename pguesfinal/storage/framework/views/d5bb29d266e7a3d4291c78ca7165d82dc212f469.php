...
<h >En atención a lo establecido en el art.194 del Reglamento General de la Gesti&oacute;n Acad&eacute;mico &#45; Administrativo de la Universidad de El Salvador, le solicitamos interponga sus buenos oficios para que se gestione ante la Junta Directiva de esta Facultad la aprobación del tema, nombramiento del/los docente asesor y establecimiento del periodo de tiempo para su desarrollo, para el trabajo que se detalla a continuaci&oacute;n:</h>
</p><?php foreach($grupo as $gru): ?>
	<?php if($gru->codigoG==$codigo): ?>
<p align="justify"><h>Trabajo de Graduaci&oacute;n desarrollado por el grupo N&#176;:<?php echo e($gru->codigoG); ?>:</h></p>	
	<?php endif; ?>
	<?php endforeach; ?>
...
<p align="justify"><h >Se anexa el perfil, Dictamen de aprobaci&oacute;n del tema, carta de la instituci&oacute;n contraparte y la respectiva constancia de inscripci&oacute;n por parte de la acad&eacute;mica de esta Facultad.</h></p>
