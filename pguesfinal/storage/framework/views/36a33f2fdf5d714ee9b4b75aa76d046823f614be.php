    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="#" onclick="ventanaC('<?php echo e($grupos->idgrupo); ?>')" >Imprimir Cronograma</a></li>
        </ul>                     
          </li>
            </ul>
...
{
ventana1=window.open("<?php echo e(url('ues/grupos/steps/notasG')); ?>"+"/"+ id,'scrollbars=yes,width=800,height=1000,titlebar=no'); 
}
</script>
