...
role="dialog" tabindex="-1" id="modal-ver-<?php echo e($per->idpersona); ?>">
	<?php echo e(Form::Open(array('action'=>array('EstudianteHSController@show',$est->curriculum),'method'=>'PATCH'))); ?>
	...
	<div class="modal-dialog">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#00a65a; color:white">
          ...
          <h4 class="modal-title">Información del Estudiante en Servicio Social</h4>
