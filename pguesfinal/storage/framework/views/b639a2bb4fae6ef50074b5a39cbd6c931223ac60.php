...
<h>
   ...
   <?php foreach($docentes as $d): ?>
				<?php if($d->iddocente==$rlc->iddocente): ?>
					...
					<?php echo e($p->nombres); ?><?php echo e(" "); ?><?php echo e($p->apellidos); ?>
...
<h >Por medio de la presente le comunicamos no hemos podido completar el proceso de graduación en el tiempo otorgado por la Junta Directiva debido a: <?php echo e($motivo); ?></h>
...
<palign="justify"><h >Por lo que solicitamos interponga sus oficios para que la Junta Directiva otorgue prórroga para la realización del proceso de graducación.</h></p>
