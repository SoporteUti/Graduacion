 ...
 $('#modalagregardepartamento').on('show.bs.modal', function () {
	...
	<div class="row" >
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" >
			<h3>Listado de Departamentos   <button data-backdrop="static" data-keyboard="false" class="btn btn-success" data-toggle="modal" data-target="#modalagregardepartamento"><i class="fa fa-file-o"></i> Nuevo</button>   <a><button onclick="ventana()" class="btn btn-primary"><i class="fa fa-file-pdf-o" ></i> Activos </button></a>  
