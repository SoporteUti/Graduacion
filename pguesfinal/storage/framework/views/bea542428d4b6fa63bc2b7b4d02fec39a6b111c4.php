    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="background:#00a65a; color:white>
          <h4 class="modal-title">Registrar Documentación - Tribunal Calificador</h4>
        </div>
    ...
    <?php endif; ?>
         ...
         <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" >
                <div class="form-group"> 
                <label>Registrar Documentos Generados - Director General</label>
                    <div class="input-group">                   
                        <span class="input-group-addon"><i class="fa fa-info"></i></span>
    ...
    <a href="<?php echo e(asset('storage/documentosrecibidos/'.$gs->pdfrecibido)); ?>" target="_blank" >
           ...
           <?php endif; ?>
             <div  class="col-lg-12 col-md-12 col-xs-12 col-sm-12" >
                <div class="form-group"> 
                <label>Numero de Acuerdo de Aprobación</label>
                    <div class="input-group">                   
                        <span class="input-group-addon"><i class="fa fa-info"></i></span>
                 ...
                 <div hidden="" class="col-lg-6 col-md-6 col-xs-12 col-sm-6" >
                        ...
                        <label>Fecha de Inicio de Prórroga </label>
                            <div class="input-group">                   
                                ...
                                <input type="date" name="fecInicioPer" id="fecInicioPer" class="form-control" step="1" value="<?php echo date("Y-m-d");?>"  required="required" >
                        ...
                        <div hidden="" class="col-lg-6 col-md-6 col-xs-12 col-sm-6" >
                        <div class="form-group"> 
                        <label>Fecha de Fin de de Prórroga</label>
                            <div class="input-group">                   
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                
                                <input type="date" name="fecFinPer" id="fecFinPer" class="form-control" step="1" value="<?php echo date("Y-m-d");?>"  required="required" >
