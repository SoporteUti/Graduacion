...
<?php foreach($bitacora as $bit): ?>
 ...
 <?php endforeach; ?>
        ...
        <button type="button" onclick="location.href = '<?php  echo url('ues/seguridad/bitacora');?>'" style="width:20%" class="btn btn-danger " id="btnSalir" name="btnSalir"><i class="fa fa-arrow-circle-left"></i><br>Salir</button>
             </center>
            </div>
</div>
</div>
