...
<?php foreach($enunciado as $en): ?>
  <?php if($en->idsolicitud==10 && $en->idrol==4): ?>
  <?php echo e($en->enunciado); ?>

  <?php endif; ?>
  <?php endforeach; ?>, tengo a bien solicitarles muy respetuosamente la <strong>Impugnaci&oacute;n de Resultados</strong> del trabajo de grado que se detalla a continuaci&oacute;n:</h>
