    ...
    role="dialog" tabindex="-1" id="imprimird-5-<?php echo e($gs->idgrupsol); ?>">
    <?php echo e(Form::Open(array('action'=>array('solicitudController@impratiResulD'),'route'=>['ues.solicitudes.impratiResulD'], 'method'=>'post', 'files' =>'true'))); ?>
    ...
    <div hidden="" class="col-lg-12 col-md-12 col-xs-12 col-sm-12" >
      ...
      <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" >
        ...
        <div class="modal-footer">
          ...
          <button type="submit" onclick="" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir</button>
        </div>
      </div>
    </div>
