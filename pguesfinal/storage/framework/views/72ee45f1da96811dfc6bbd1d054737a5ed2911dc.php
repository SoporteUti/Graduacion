...
<h >En atenci&oacute;n a la solicitud presentada por el Coordinador General de Trabajos de Grado del Departamento de <?php echo e($depto); ?>, <?php echo e($coor); ?> y con el Visto Bueno del Jefe del Departamento de <?php echo e($depto); ?>, <?php echo e($jefe); ?> y <?php foreach($enunciado as $en): ?>
	<?php if($en->idsolicitud==3 && $en->idrol==4): ?>
	<?php echo e($en->enunciado); ?>

	<?php endif; ?>
	<?php endforeach; ?>, tengo a bien solicitarles muy respetuosamente la pr&oacute;rroga número <?php echo e($numerosoli); ?> al trabajo de grado que se detalla a continuaci&oacute;n:</h>
</p><?php foreach($grupo as $gru): ?>
	<?php if($gru->codigoG==$codigo): ?>
<p align="justify"><h>Trabajo de Grado desarrollado por el grupo N°:<?php echo e($gru->codigoG); ?>:</h></p>	
	<?php endif; ?>
	<?php endforeach; ?>
...
<p align="justify"><h >Anexo la correspondencia relacionada a la solicitud enviada por el Coordinador General de Trabajos de Grado del Departamento de <?php echo e($depto); ?> con el respectivo visto bueno del Jefe de Departamento</h></p>
