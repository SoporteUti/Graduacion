...
<?php echo e(Form::Open(array('action'=>array('solicitudController@impspsistemasC'),'route'=>['ues.solicitudes.impspsistemasC'], 'method'=>'post', 'files' =>'true'))); ?>
      ...
      <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6" >
            ...
            <label>Fecha de Inicio</label>
                <div class="input-group">     
                    ...
                    <input readonly=""   class="form-control"  value="<?php echo e($pi->fechaInicio); ?>"  >
                        <?php endif; ?>
                    <?php endforeach; ?>
            ...
            <label>Fecha de Finalización</label>
                <div class="input-group">                   
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                     <?php foreach($progai as $pi): ?>         
                        <?php if( $gs->idgrupsol == $pi->idgrupsol): ?> 
                    <input readonly=""   class="form-control"  value="<?php echo e($pi->fechaFinal); ?>"   >
                     <?php endif; ?>
                    <?php endforeach; ?>
