...
<h >En atenci&oacute;n a la solicitud presentada por el Coordinador General de Trabajos de Graduaci&oacute;n del <?php echo e($depto); ?>, <?php echo e($coor); ?> y con el Visto Bueno del Jefe del <?php echo e($depto); ?>, <?php echo e($jefe); ?> y 
  <?php foreach($enunciado as $en): ?>
  <?php if($en->idsolicitud==5 && $en->idrol==4): ?>
  <?php echo e($en->enunciado); ?>

  <?php endif; ?>
  <?php endforeach; ?>, tengo a bien solicitarles muy respetuosamente la <strong>Ratificación de Resultados</strong> del trabajo de graduaci&oacute;n que se detalla a continuaci&oacute;n:</h>
