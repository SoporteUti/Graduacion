...
<h ><?php foreach($enunciado as $en): ?>
  <?php if($en->idsolicitud==8 &&$en->idrol==3): ?>
  <?php echo e($en->enunciado); ?>

  <?php endif; ?>
  <?php endforeach; ?>, le solicitamos que se gestione ante la Junta Directiva la <strong>reprobaci&oacute;n</strong>  por abandono de parte del/la estudiante con carnet N°: <?php echo e($estudianteselec); ?> al Trabajo de Graduaci&oacute;n que se detalla a continuaci&oacute;n:</h>
<p align="justify">
         <?php foreach($grupo as $gru): ?>
         <?php if($gru->codigoG==$codigo): ?>
C&oacute;digo: <?php echo e($gru->codigoG); ?>
