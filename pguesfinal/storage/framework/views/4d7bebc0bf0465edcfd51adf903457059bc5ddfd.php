...
<h > <?php foreach($enunciado as $en): ?>
	...
	<?php endif; ?>
	<?php endforeach; ?>, le solicitamos interponga sus buenos oficios para que la Junta Directiva de esta Facultad otorgue la  pr&oacute;rroga n&uacute;mero <?php echo e($numerosoli); ?> al Trabajo de Graduaci&oacute;n que se detalla a continuaci&oacute;n: </h>
