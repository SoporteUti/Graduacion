...
$(document).ready(function() {
    ...
    $('#modalagregaretapa').bootstrapValidator({
       feedbackIcons: {
        ...
        fields: {
           idetapa: {
                validators: {
                    notEmpty: {
                        message: 'Seleccione Tipo de Proceso  - Carrera '
                    },
                ...
                validators: {
                    notEmpty: {
                        message: 'Ingrese el nombre de la Etapa '
                    },
                    stringLength: {
                        min: 10,
                        max: 256,
         ...
         bootbox.dialog({
              ...
              buttons: {
                success: {
                  ...
                  callback: function() {
                    var formulario = document.getElementById('etapa');
                    formulario.submit();
                  }
                },
                danger: {
