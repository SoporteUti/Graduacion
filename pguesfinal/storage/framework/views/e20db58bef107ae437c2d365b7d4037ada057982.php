    ...
    role="dialog" tabindex="-1" id="registrard-2-<?php echo e($gs->idgrupsol); ?>">
    <?php echo e(Form::Open(array('action'=>array('solicitudController@registrardocpinterna'),'route'=>['ues.solicitudes.registrardocpinterna'], 'method'=>'post', 'files' =>'true'))); ?>

    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="background:#00a65a; color:white>
          <h4 class="modal-title">Registrar Documentación - Prórroga Interna </h4>
        </div>
