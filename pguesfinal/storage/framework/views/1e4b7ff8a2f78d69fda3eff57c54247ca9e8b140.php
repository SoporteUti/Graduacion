       ...
       <ul class="nav navbar-nav ">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
                      <?php /* <?php foreach($Solicitudes as $sol): ?>
                        <!-- numero de solicitud -->
                      <li><a href="#solicitud-<?php echo e($sol->idsolicitud); ?>" data-toggle="modal" data-target="#solicitud-<?php echo e($sol->idsolicitud); ?>"><?php echo e($sol->nombre); ?></a></li>
                      <?php endforeach; ?> */ ?>
                      ...
                      <?php /*<li><a href="" data-target="#solicitud-4" data-toggle="modal">Ratificación Tribunal Calificador</a></li>*/ ?>
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="#" onclick="loadAlumns(<?php echo e($grupos->idgrupo); ?>)" data-target="#modal-asistencia" data-toggle="modal">Control de asesorias</a></li>
                  ...
                  <?php endforeach; ?>
                   <?php endif; ?>
                    ...
                    <?php endif; ?>
                        ...
                        <td ><a href=""  data-target="#imprimirc-<?php echo e($sol->idsolicitud); ?>-<?php echo e($gs->idgrupsol); ?>" data-toggle="modal">
...
<?php if($gs->estado==3): ?>
<a href=""  data-target="#eliminars-<?php echo e($gs->idgrupsol); ?>" data-toggle="modal">
...
<?php endif; ?>
                          ...
                          <?php echo $__env->make('ues.grupos.eliminars', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
   ...
   <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">  
          <div class="form-group"> 
                ...
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                    ...
                    <input type="date" name="fechar" id="fechar" class="form-control" value="<?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?>" required="required" title="">
                  </div>
