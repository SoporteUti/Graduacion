<?php $__env->startSection('contenido'); ?>
    <?php if(Auth::user()->idrol == 4): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if($sol->idsolicitud != 2 && $sol->idsolicitud != 7): ?>
                                                                    <a href=""
                                                                        data-target="#imprimird-<?php echo e($sol->idsolicitud); ?>-<?php echo e($gs->idgrupsol); ?>"
                                                                        data-toggle="modal">
                                                                    ...
                                                                    <?php if(($gs->estado == 0 && $gs->condicion == true) || $gs->estado == 1 || $gs->estado == 7): ?>
                                                                        <a href=""
                                                                            data-target="#registrard-<?php echo e($sol->idsolicitud); ?>-<?php echo e($gs->idgrupsol); ?>"
                                                                            data-toggle="modal">
                                                            ...
                                                            <?php echo $__env->make('ues.grupos.imprimir9director', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                            <?php echo $__env->make('ues.grupos.imprimir10director', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                            ...
                                                            <?php echo $__env->make('ues.grupos.registrar9director', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                            <?php echo $__env->make('ues.grupos.registrar10director', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="modal fade" id="solicitud-6">
            <?php echo e(Form::Open(['action' => ['solicitudpicController@spiconta'], 'route' => ['ues.solicitudesconta.spiconta'], 'method' => 'post', 'files' => 'true'])); ?>
